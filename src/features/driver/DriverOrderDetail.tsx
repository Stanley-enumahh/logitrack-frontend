          ...
          <div className="px-6 py-5 space-y-6">
            ...
            {locationError && (
              <div className="space-y-2">
                ...
                {/* TEMP DEBUG — remove once location issue is resolved */}
                {locationDebug && (
                  <p className="text-amber-700 text-xs font-mono bg-amber-50 border border-amber-200 rounded-md px-3 py-2 break-all">
                    DEBUG: {locationDebug}
                  </p>
                )}
              </div>
